...
# Configuration Script – MIR-IR100 - Rev. A

This **Configuration** script is designed for the **MIR-IR100** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – MIR-IR100 Rev. A

Este script de **Configuration** está diseñado para el modelo **MIR-IR100** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
